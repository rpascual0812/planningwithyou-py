...
def ensure_created_by_column(apps, schema_editor):
    ...
    schema_editor.add_field(BookingItem, field)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bookings', '0027_rename_booking_created_by_column'),
    ]

    operations = [
        migrations.RunPython(ensure_created_by_column, migrations.RunPython.noop),
